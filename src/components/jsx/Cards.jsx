...
<div className="card" style={{width: "18rem",borderRadius:"30px"}}>
  <img className="card-img-top" src={CardData.imgSrc.default} style={{borderRadius:"30px",minWidth: "285px",maxWidth: "285px",minHeight:"250px",maxHeight: "250px"}} alt="Card image cap"/>
