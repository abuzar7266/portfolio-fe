        ...
        <Navbar collapseOnSelect expand="lg" style={{backgroundColor:"#1C2331",color:"white"}}>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                    ...
                    lg={3}h
                    style={{margin:"10px"}}>
                    <NavLink activeClassName="is-active" className="" style={{color:"white",textDecoration:"none"}} exact={true}  to="./" > Home </NavLink></Col>
                    <Col
                    xs={12}
                    sm={12}
                    md={12}
                    lg={3}
                    style={{margin:"10px"}}><NavLink  className="" activeClassName="is-active" style={{color:"white",textDecoration:"none"}} exact={true} to="./about" > About </NavLink></Col>
                    <Col
                    xs={12}
                    sm={12}
                    md={12}
                    lg={3}
                    style={{margin:"10px"}}><NavLink  className="" activeClassName="is-active" style={{color:"white",textDecoration:"none"}} exact={true} to="./contact" > Contact </NavLink></Col>
                </Nav>
            </Navbar.Collapse>
        </Navbar>
        </Row>
